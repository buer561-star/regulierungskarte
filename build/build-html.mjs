...
if (!tpl.includes("__MAPDATA__") || !tpl.includes("__INSTRDATA__")) throw new Error("Platzhalter __MAPDATA__/__INSTRDATA__ fehlt im Template");
const html = tpl
...
console.log(`index.html geschrieben (${mb} MB) · Instrumente: ${instruments.length}, Relationen: ${relations.length}, Aliase: ${aliases.length}`);

...
- **Zweitwohnungs-/Erstwohnungsanteils-Steuerung (Lex Weber / Zweitwohnungsgesetz).** Instrumente, deren tragender Mechanismus die **raumplanerische Steuerung des Erst-/Zweitwohnungsmix** ist — **Erstwohnungsanteil/-pflicht (EWA/EWAP)**, **Zweitwohnungsanteil-Begrenzung/-Beschränkung**, **Lenkungs-/Ersatzabgaben auf Zweitwohnungen**, touristische **Bewirtschaftungs-/Umnutzungssteuerung** — gehören in die **Zweitwohnungs-/Tourismusraumplanung (Lex Weber)** und **NICHT** in diese Wohnregulierungs-Taxonomie. Sie schützen **nicht** den **bezahlbaren (Miet-)Wohnbestand** und enthalten **keine** Mietzins-/Belegungskontrolle. **Insbesondere NICHT Kat 5.** Grund: `Zweitwohnungs-/Erstwohnungsanteils-Steuerung (Lex Weber)`.
  - **ABGRENZUNG — bleibt Kat 5:** Genuiner **Zweckentfremdungs-/Wohnschutz des allgemeinen (Miet-)Wohnbestands** — Abbruch-/Umnutzungs-/Zweckänderungsverbote zum Erhalt von Wohnraum sowie **Kurzzeitvermietungs-/Airbnb-Beschränkungen** (LDTR GE, VD, „Lex Airbnb", kommunale Airbnb-Reglemente), die Wohnungen der **Wohnnutzung** erhalten. Diese sind **Kat 5**, auch wenn der Begriff „Zweitwohnung" vorkommt. Die Trennlinie: **Steuerung des Erst-/Zweitwohnungs-MIX → ausgeschlossen**; **Schutz von Wohnraum vor Entzug aus der Wohnnutzung → Kat 5**.

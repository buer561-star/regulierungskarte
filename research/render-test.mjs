...
A($$("#rtable tbody tr").length === 65, `Tabelle: 65 Instrument-Zeilen (ist ${$$("#rtable tbody tr").length})`);
...
A($$("#audit-wrap .acard").length >= 13, `Audit-Liste zeigt >=13 Berichte (ist ${$$("#audit-wrap .acard").length})`);
